...
#service .av_textblock_section .avia_textblock h2 {
    font-size: 1.3rem;
}

/*=== Core issues text only ===*/
...
.flex_column.av_one_third.av-animated-generic.right-to-left.flex_column_div.av-zero-column-padding.avia-builder-el-29.el_after_av_one_third.avia-builder-el-last.column-top-margin.avia_start_animation.avia_start_delayed_animation {
    background-color: rgba(0, 0, 0, 0.65);
    padding: 15px 5px 0px 15px;
    box-shadow: 0.5px 0.5px 5px 1px rgba(0, 0, 0, 0.33);
}
